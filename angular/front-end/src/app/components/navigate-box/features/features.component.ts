...
//     this.characterService.currentCharacter.classes[0].features = this.characterService.currentCharacter.classes[0].features.filter((feature: any) => feature.id != id);
//   }
...
//     if (featureToAdd) {
//       this.characterService.currentCharacter.classes[0].features.push(featureToAdd);
